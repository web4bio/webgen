...
buildDownloadData = async function (cohortID, genes, clin_vars, expressionData, clinicalData) {
    ...
    let csv_string_expZscore = "Z-scored Gene Expression, TCGA Cohort:," + cohortID + ", Generated By WebGen: https://web4bio.github.io/webgen/ \n"; // header for zscore csv
    let csv_string_expLog2 = "Log2 Gene Expression, TCGA Cohort:," + cohortID + ", Generated By WebGen: https://web4bio.github.io/webgen/ \n"; // header for expression_log2 csv
