...
// Function that calls fetchgetExpressionDataJSONarray_cgbExpressionData and returns the useful format of the data:
//  = async function(cohortQuery, geneQuery, barcodes) {
