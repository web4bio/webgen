...
### Temp because working with 4000X4000 patches then resizing to 400X400 to work with AE for now
...
patients_dir = '/data03/shared/yuwei/paad_patches/PAAD_patches_1dim_400X'

destination_dir = '/data01/shared/skobayashi/PAAD_patches_400X400_whiteFiltered'
...
def detect_white(imagePath):
    ...
    print('FInal dimensions are: %s by %s' % (str(patch.size[0]),str(patch.size[1])))
