...
def main():
    ...
    #Directories:
    saved_models = os.path.join(os.getcwd(),'saved_models_savedModelTest')
    ...
    source = '/data01/shared/skobayashi/PAAD_patches_400X400_whiteFiltered/Split/'
    ...
    # checkpoint
    filepath="./saved_models_savedModelTest/weights_best.h5"
